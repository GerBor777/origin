    ...
    , ui(new Ui::MainWindow)
{
    ...
    // Сигналы по завершению потоков QThread
    ...
    // Сигналы по завершению QtConcurrent потоков
